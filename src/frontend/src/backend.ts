...
export class Backend implements backendInterface {
    ...
    async getActiveBill(): Promise<BillView> {
        if (this.processError) {
            try {
                const result = await this.actor.getActiveBill();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async payActiveBill(): Promise<BillView> {
        if (this.processError) {
            try {
                const result = await this.actor.payActiveBill();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
