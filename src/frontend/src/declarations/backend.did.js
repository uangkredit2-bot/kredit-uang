...
export const BillView = IDL.Record({
  'id' : BillId,
  'title' : IDL.Text,
  'paymentStatus' : IDL.Text,
  'confirmationStatus' : IDL.Text,
  'paid' : IDL.Bool,
  'updatedAt' : Timestamp,
  'amount' : IDL.Nat,
});
...
export const idlService = IDL.Service({
  ...
  'getActiveBill' : IDL.Func([], [BillView], ['query']),
  'getApiDoc' : IDL.Func([], [IDL.Text], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
  'isCallerAdmin' : IDL.Func([], [IDL.Bool], ['query']),
  'payActiveBill' : IDL.Func([], [BillView], []),
